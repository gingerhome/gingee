<img src="images/ginger.png" alt="Ginger" width="250"/>
...
| :--- | :--- |
| **[Core Concepts](./docs/concepts.html)** | **Start Here.** A high-level overview of the GingerJS philosophy, project structure, the sandbox, and the module ecosystem. |
| **[GingerJS CLI](./docs/gingerjs-cli.html)** | The all-in-one command-line interface for the GingerJS platform |
| **[Server Configuration (`ginger.json`)](./docs/server-config.html)** | A full reference guide for the server-wide `ginger.json` file, controlling settings like ports, caching, and security. |
| **[Glade Admin Panel](./docs/glade-admin.html)** | Glade is the official, web-based administration panel for GingerJS |
...
| **[Features](./docs/features.html)** | The list of features supported by GingerJS |
| **[App Developer Guide](./docs/app-developer-guide.html)** | The list of features supported by GingerJS |
| **[App Packaging Guide](./docs/packaging-guide.html)** | GingerJS platform's standardized application packaging process |
| **[App Permissions Guide](./docs/permissions-guide.html)** | GingerJS platform's app permissions ecosystem. |
| **[GStore Hosting Guide](./docs/gstore-hosting-guide.html)** | GingerJS platform's decentralized app store hosting guide |
| **[Full API Reference](./index.html)** | The complete JSDoc-generated API documentation for every function in every GingerJS app module. |
