...
class MysqlAdapter {
  ...
  async query(sql, params = []) {
    try {
      ...
      this.logger.error(`MySQL: query error ${error.message} for SQL: ${sql}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  async execute(sql, params = []) {
    try {
      ...
      this.logger.error(
        `MySQL: execute error ${error.message} for SQL: ${sql}`,
        { stack: error.stack },
      );
      throw error;
    }
  ...
  async transaction(callback) {
    ...
    try {
      ...
      this.logger.error(`MySQL: transaction error ${err.message}`, {
        stack: err.stack,
      });
      throw err;
    } finally {
